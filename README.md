...
Load balancing ensures that the application will be highly **redundant/available**, in addition to restricting **all access expect administrative access** to the network.
